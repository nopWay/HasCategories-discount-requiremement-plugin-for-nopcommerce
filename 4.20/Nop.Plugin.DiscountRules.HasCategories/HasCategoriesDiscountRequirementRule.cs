...
namespace Nop.Plugin.DiscountRules.HasCategories
{
    public partial class HasCategoriesDiscountRequirementRule : BasePlugin, IDiscountRequirementRule
    {
        ...
        public override void Install()
        {
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.DiscountRules.HasCategories.Show.Selected", "Show only selected categories ({0})");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.DiscountRules.HasCategories.Hide.Selected", "Back | Selected categories ({0})");
            ...
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.DiscountRules.HasCategories.Show.Excluded", "Show only excluded products ({0})");
            _localizationService.AddOrUpdatePluginLocaleResource("Plugins.DiscountRules.HasCategories.Hide.Excluded", "Back | Excluded products ({0})");
        ...
        public override void Uninstall()
        {
            ...
            _localizationService.DeletePluginLocaleResource("Plugins.DiscountRules.HasCategories.Show.Selected");
            _localizationService.DeletePluginLocaleResource("Plugins.DiscountRules.HasCategories.Hide.Selected");
            _localizationService.DeletePluginLocaleResource("Plugins.DiscountRules.HasCategories.Not.Selected");
            _localizationService.DeletePluginLocaleResource("Plugins.DiscountRules.HasCategories.Show.Excluded");
            _localizationService.DeletePluginLocaleResource("Plugins.DiscountRules.HasCategories.Hide.Excluded");
